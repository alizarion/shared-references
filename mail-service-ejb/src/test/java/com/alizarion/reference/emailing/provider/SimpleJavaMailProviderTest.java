...
import com.alizarion.reference.emailing.helper.Helper;
...
public class SimpleJavaMailProviderTest {
    ...
    public void setUp() throws Exception {
        ...
        out2.close();
        this.registerEmail = (RegisterEmail) Helper.getRegisterEmail();
    ...
    public void sendMailTest() throws EmailException {
        ...
        this.registerEmail = (RegisterEmail) javaMailProvider.sendMail(this.registerEmail);
    }
