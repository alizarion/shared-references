...
import com.alizarion.reference.security.oauth.oauth2.toolkit.TokenInfoDTO;
...
public class TokenInfoEndPoint {
    ...
    /**
     * Method that provide the access token,
     * for and linked authorization.
     * @param request that contain all params of the request.
     * @return and access token response.
